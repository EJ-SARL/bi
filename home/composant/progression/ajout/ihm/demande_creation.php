...
<hr /><ol class="breadcrumb bc-3" >
	...
	<li>
		<a href="?page=recuperer_progressions">Progression</a>
	</li>
	<li class="active">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form method="POST" action="index.php?demande=ajouter_progression"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
			

			

				<div class="form-group">		
						<label class="col-sm-3 control-label">Date initiale</label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<select name="projet" id="projet"  class="form-control">
										<option value="">--Selectionner la date initiale--</option>
										<?php
											for($i=0; $i < count($projets); $i++)
												{         
													echo"  
															<option value=" . $projets[$i]->id ."> " . $projets[$i]->nom ."</option>                       
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Periode Ancienne</label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<select name="departement" id="departement"  class="form-control">
										<option value="">--Selectionner la Periode Ancienne--</option>
										<?php
											for($i=0; $i < count($indicateurs); $i++)
												{         
													echo"  
															<option value=" . $indicateurs[$i]->id ."> " . $indicateurs[$i]->indicateur ."</option>                       
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Periode recente </label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<select name="periode" id="departement"  class="form-control">
										<option value="">--Selectionner la Periode recente--</option>
										<?php
											for($i=0; $i < count($periodes); $i++)
												{         
													echo"  
															<option value=" . $periodes[$i]->id ."> " . $periodes[$i]->periode ."</option>                       
