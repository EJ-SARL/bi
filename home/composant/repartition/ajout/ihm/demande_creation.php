...
<hr /><ol class="breadcrumb bc-3" >
	...
	<li>
		<a href="?page=recuperer_repartitions">Repartition</a>
	</li>
	<li class="active">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form method="POST" action="index.php?demande=ajouter_repartition"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
				...
				<div class="form-group">		
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Indicateur</label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<select name="departement" id="departement"  class="form-control">
										<option value="">--Selectionner l'indicateur--</option>
										<?php
