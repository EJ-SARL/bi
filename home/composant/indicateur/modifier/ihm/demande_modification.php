...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<form method="POST" action="index.php?demande=modifier_indicateur"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
						...
						<label class="col-sm-3 control-label">Projet</label>
							<div class="col-sm-5">
								<div class="input-group">
									...
									<option value=<?php echo $projet_id;?> ><?php echo $projet;?> </option>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Fréquence<abbr style="color:green; font-size:15px;">**</abbr></label>			
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<input type="text" name="frequence" class="form-control" value=<?php echo $frequence;?> placeholder=" frequence" required="required">
									<span class="input-group-addon"><i class=""></i></span>
								</div>
							</div>
					</div>
						...
						<label class="col-sm-3 control-label">Ordre<abbr style="color:green; font-size:15px;">**</abbr></label>			
							<div class="col-sm-5">
								<div class="input-group">
									...
									<option value=<?php echo $ordre;?>  selected><?php echo $ordre;?> </option>
						...
						<label class="col-sm-3 control-label">L'unité<abbr style="color:green; font-size:15px;">**</abbr></label>			
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input type="text" name="unite" class="form-control" value=<?php echo $unite;?> placeholder=" Unité" required="required">
									<span class="input-group-addon"><i class=""></i></span>
								</div>
							</div>
					</div> 
